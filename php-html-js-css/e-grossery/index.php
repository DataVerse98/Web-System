<?php include("conn.php");
	...
	if (isset($_POST['cust_email']))
	{
		...
		$sql = " SELECT * FROM customers WHERE cust_email = '".$_POST['cust_email']."' AND cust_pass = '".$_POST['psw']."' ";
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Enter Email*" name="cust_email" style="text-align: center" required>
                            </div>
                            <div class="form-group">
