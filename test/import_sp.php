<?php 
	...
	for($row = 1;$row<=$highestRow;$row++){
		...
		$sql = "INSERT INTO certificate (type_cer,date_generate,ref_no,kp_id,title,tarikh_mula,tarikh_tamat) VALUES ('".$type_cer."','".$current_date."','".$rowData[0][0]."', '".$rowData[0][1]."','".$rowData[0][2]."','".$my_date."','".$my_date2."')";
...
<html>
	...
	<?php include "navbar.php";?>
						...
						<tbody id="tableData">
							<?php do { ?>
								<tr>
									...
									<a type="button" name="delete" href="delete_sp.php?id=<?php echo $row['rec_id'];?>" title="delete">
										<image src="img/delete.png" style="width: 20px; height: 20px;" alt="delete icon">
									</a>
									<a href="surat_pelantikan.php?id=<?php echo $row['rec_id']; ?>" title="download">
		...
		<div align="center">
			<form action = "import_sp.php" method="POST" enctype="multipart/form-data" >
				<input type="file" name="file">
				<input type="submit" name="upload" value="upload">
				<a type="button" name="contoh" href="file/contoh_surat_pelantikan.xlsx" value="example">example</a>
			</form>
		</div>
	</body>
</html>