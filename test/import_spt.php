...
<?php	
	...
	if(isset($_POST['upload'])){
		...
		try {
			...
			echo "<script>
					alert('File Empty.');
					window.location = 'import_spt.php';
				</script>";
		}
	...
	for($row = 1;$row<=$highestRow;$row++){
		...
		$sql = "INSERT INTO certificate (type_cer,date_generate,ref_no,kp_id,ap1_id,ap2_id,title,tempoh,tarikh_mula,tarikh_tamat) VALUES ('".$type_cer."','".$current_date."','".$rowData[0][0]."', '".$rowData[0][1]."','".$rowData[0][2]."','".$rowData[0][3]."','".$rowData[0][4]."','".$rowData[0][5]."','".$my_date."','".$my_date2."')";
...
<html>
	...
	<?php include "navbar.php";?>
						...
						<tbody id="tableData">
							<?php do { ?>
								<tr>
									...
									<a type="button" name="delete" href="delete_spt.php?id=<?php echo $row['rec_id']; ?>" title="delete">
		...
		<div align="center">
			<form action = "import_spt.php" method="POST" enctype="multipart/form-data" >
				<input type="file" name="file">
				<input type="submit" name="upload" value="upload">
				<a type="button" name="contoh" href="file/contoh_surat_pt.xlsx" value="example">example</a>
			</form>
		</div>
	</body>
</html>