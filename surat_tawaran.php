	...
	<body> <!--onLoad="javascript:print()"-->
		...
		<div class="page">
			...
			<div id="pg_1">
				...
				<?php }?>
				<p> Tuan/Puan </p>
				<p style="text-transform: uppercase;"> <strong> TAWARAN GERAN DANA KECEMERLANGAN UiTM SARAWAK <?php echo $year;?>:</strong><br>
		...
		<div class="page">
			...
			<!--<button type="button" id="pdfDownloader" >Download</button>--> <!--id="pdfDownloader"-->
		</div>
		<?php }else{?>
			<div class="page">
